    ...
    >
        <g>
            <g>
                <path 
                    fill="#dddddd"
                    d="M418.9,382.55H18.2c-5,0-9.1-4.1-9.1-9.1v-52.9h419v52.9C428.1,378.45,424,382.55,418.9,382.55z"
                />
                <path 
                    fill="#3C92CA"
                    d="M450.3,26.75H275.4c-15.8,0-28.8,13-28.8,28.8v106.8c0,15.8,13,28.8,28.8,28.8H298v51l53.2-51h99.1
                    c15.8,0,28.8-13,28.8-28.8V55.55C479.1,39.65,466.2,26.75,450.3,26.75z"
                />
                <path 
                    fill="#fff"
                    d="M428.1,218.75c-5,0-9.1,4.1-9.1,9.1v87.3H18.1v-198.7c0-10.8,8.8-19.7,19.7-19.7h173.5c5,0,9.1-4.1,9.1-9.1
                ...
                />
                <path 
                    d="M450.3,17.65H275.4c-20.9,0-37.9,17-37.9,37.9v106.8c0,20.9,17,37.9,37.9,37.9h13.5v41.9c0,3.6,2.2,6.9,5.5,8.3
                ...
                />
                <path 
                    d="M362.9,103.35c-2.4,0-4.7,1-6.4,2.6c-1.7,1.7-2.7,4-2.7,6.4s1,4.7,2.7,6.4s4,2.6,6.4,2.6s4.7-1,6.4-2.6
                    c1.7-1.7,2.7-4,2.7-6.4s-1-4.7-2.7-6.4C367.6,104.25,365.2,103.35,362.9,103.35z"
                />
                <path 
                    d="M396.6,103.35c-2.4,0-4.7,1-6.4,2.6c-1.7,1.7-2.7,4-2.7,6.4s1,4.7,2.7,6.4s4,2.6,6.4,2.6s4.7-1,6.4-2.6
                    c1.7-1.7,2.7-4,2.7-6.4s-1-4.7-2.7-6.4C401.3,104.25,399,103.35,396.6,103.35z"
                />
                <path 
                    d="M329.1,103.35c-2.4,0-4.7,1-6.4,2.6c-1.7,1.7-2.7,4-2.7,6.4s1,4.7,2.7,6.4s4,2.6,6.4,2.6s4.7-1,6.4-2.6
